...
#define LogError(...)                     \
    Logger::LogError_(__FILE__, __LINE__, \
                      static_cast<const char *>(TOOLBOX_FUNCTION), __VA_ARGS__)
...
#define LogWarning(...)                                             \
    Logger::LogWarning_(__FILE__, __LINE__,                         \
                        static_cast<const char *>(TOOLBOX_FUNCTION), \
                        __VA_ARGS__)
...
public:
    ...
    /// redirect prints rather than printing to stdout. For example, in TOOLBOX's
    ...
    /// Set global verbosity level of TOOLBOX.
    ///
    ...
    /// Get global verbosity level of TOOLBOX.
